# Blackbird portfolio & partner reference

Living reference for **The Blackbird Brief** (`podcasts/blackbird-brief/`).
Defines what "portfolio-relevant" means and lists the people, targets,
...
## 2. Portfolio companies & programs
...
- **Lead indication signal:** hereditary **hearing loss** (cell-type selectivity
  is a strong fit for inner-ear cell targeting).
- **People:** **Geoffrey M. Lynn, MD/PhD** — founding CEO (prev. founder/CEO of
  Avidea Technologies → acquired by Vaccitech / now Barinthus Biotherapeutics,
  where he was CSO).
- **Status:** First **fully incubated** Blackbird spinout (nonprofit grant →
  seed → BioHub bench — the full-model proof point). Closed a **seed** round;
  resident in the Blackbird BioHub.
...
- **What:** **GPR52 agonist** program for schizophrenia. GPR52 is a
  ...
  Institute**; venture partner **Third Rock Ventures**.
- **Status:** Blackbird ran a ~9-month, **$2M medicinal-chemistry campaign** to a
  lead-quality molecule; **development candidate expected later in 2026**. ⚠
  NewCo name not yet public.
- **Watch:** GPR52 agonists broadly (others chasing the target); the new wave of
...
- **Watch:** IBD (Crohn's/UC) competitive landscape — oral & gut-restricted
  agents, IBD-associated pain; GCPII/NAALADase biology.
...
- **Sourcing Radar (daily):** a JHU/UMB/Lieber paper is a strong lead if it has
  a novel target, a platform, or a translational result with defensible IP and
  unmet need — i.e. the kind of thing Blackbird would license and incubate.
  Bonus if it sits adjacent to a portfolio thesis above (selective gene
  delivery, neuropsych GPCRs, gut-restricted small molecules, RNA upregulation,
  IO).
- **Portfolio Watch (weekly):** anything moving the competitive/regulatory/
  financing picture for the programs above. Always name the program it touches
